import { c as create_ssr_component, a as subscribe, b as add_attribute, e as each, d as add_styles, f as merge_ssr_styles, g as escape, v as validate_component, m as missing_component, n as noop, h as compute_rest_props, o as onDestroy, i as spread, j as escape_attribute_value, k as escape_object, l as get_store_value } from "../../chunks/ssr.js";
import { c as cn$1, b as buttonVariants, I as Input } from "../../chunks/input.js";
import { R as Root, T as Trigger, D as Dialog_content, a as Dialog_header, b as Dialog_title } from "../../chunks/axios.js";
import { p as page } from "../../chunks/stores.js";
import { D as DataCard, a as DataEditDrawer } from "../../chunks/DataCard.js";
import { S as Scroll_area } from "../../chunks/KeywordSelect.js";
...
const logo = "/_app/immutable/assets/logo.B2gzpiGO.png";
const Menu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800"><ul class="space-y-2 font-medium"><li><a${add_attribute("aria-current", $page.url.pathname === "/data" ? "page" : void 0, 0)} href="/data" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"><span class="flex-1 ms-3 whitespace-nowrap" data-svelte-h="svelte-1bj3bwd">데이터 관리</span></a></li> <li${add_attribute("aria-current", $page.url.pathname === "/category" ? "page" : void 0, 0)}><a href="/category" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" data-svelte-h="svelte-19bdxos"><span class="flex-1 ms-3 whitespace-nowrap">카테고리 관리</span></a></li> <li${add_attribute("aria-current", $page.url.pathname === "/keyword" ? "page" : void 0, 0)}><a href="/keyword" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" data-svelte-h="svelte-rcd5yn"><span class="flex-1 ms-3 whitespace-nowrap">키워드 관리</span></a></li> <li${add_attribute("aria-current", $page.url.pathname === "/platform" ? "page" : void 0, 0)}><a href="/platform" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" data-svelte-h="svelte-3rwsvi"><span class="flex-1 ms-3 whitespace-nowrap">플랫폼 관리</span></a></li> <li${add_attribute("aria-current", $page.url.pathname === "/publish" ? "page" : void 0, 0)}><a href="/publish" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" data-svelte-h="svelte-11vrdua"><span class="flex-1 ms-3 whitespace-nowrap">데이터 업데이트</span></a></li></ul></div>`;
});
...
const DataSearchDialog = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let open = false;
  let input = "";
      ...
      },
      {
        default: () => {
          return `${validate_component(Trigger, "Dialog.Trigger").$$render(
            $$result,
            {
              class: cn$1(buttonVariants({ variant: "outline" }), "w-[180px] text-sm h-[30px]")
            },
            {},
            {
              default: () => {
                return `<span class="w-full text-left" data-svelte-h="svelte-69y6rk">검색하기...</span>`;
              }
            }
          )} ${validate_component(Dialog_content, "Dialog.Content").$$render(
            $$result,
            {
              class: "sm:max-w-[425px] h-3/4 content-start"
            },
            {},
            {
              default: () => {
                return `${validate_component(Dialog_header, "Dialog.Header").$$render($$result, {}, {}, {
                  ...
                  {}
                )}</div> ${validate_component(Scroll_area, "ScrollArea").$$render($$result, {}, {}, {
                  default: () => {
                    return `<div>${searchDatas && searchDatas.length <= 0 ? `<div data-svelte-h="svelte-x92r6u">검색 결과가 없습니다.</div>` : `${searchDatas && searchDatas.length > 0 ? `<div class="space-y-4">${each(searchDatas, (data) => {
                      return `${validate_component(DataCard, "DataCard").$$render($$result, { data }, {}, {})}`;
                    })}</div>` : ``}`}</div>`;
                  }
                })}`;
              }
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$result.head = previous_head;
    $$rendered = `  <div>${escape($page.data?.user?.nickname)}</div> <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700"><div class="px-3 py-3 lg:px-5 lg:pl-3"><div class="flex items-center justify-between"><div class="flex items-center justify-start rtl:justify-end">${validate_component(Root, "Dialog.Root").$$render(
      $$result,
      { open },
      {
        open: ($$value) => {
      ...
      },
      {
        default: () => {
          return `${validate_component(Trigger, "Dialog.Trigger").$$render(
            ...
            {
              default: () => {
                return `<svg class="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" fill-rule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path></svg>`;
              }
            }
          )} ${validate_component(Dialog_content, "Dialog.Content").$$render(
            $$result,
            ...
            {},
            {
              default: () => {
                ...
                })} ${validate_component(Menu, "Menu").$$render($$result, { handleClick: toggleMenu }, {}, {})}`;
              }
            }
          )}`;
        }
      }
    )} <a href="/" class="ms-2 md:me-24 hidden sm:flex" data-svelte-h="svelte-1e69btm"><img${add_attribute("src", logo, 0)} class="h-8 me-3" alt="Warchive Logo"> <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Warchive</span></a></div> <div class="flex items-center"><div class="flex items-center ms-3"><div>${validate_component(DataSearchDialog, "DataSearchDialog").$$render($$result, {}, {}, {})} ${validate_component(DataEditDrawer, "DataEditDrawer").$$render($$result, { action: "add" }, {}, {})}</div></div></div></div></div></nav> <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700">${validate_component(Menu, "Menu").$$render(
      $$result,
      {
        handleClick: () => {
        }
...
const css = {
  code: ".app.svelte-2gu5lj{display:flex;flex-direction:column;min-height:100vh}footer.svelte-2gu5lj{display:flex;flex-direction:column;justify-content:center;align-items:center;padding:12px;font-size:small}@media(min-width: 480px){footer.svelte-2gu5lj{padding:12px 0}}",
  map: '{"version":3,"file":"+layout.svelte","sources":["+layout.svelte"],"sourcesContent":["<script lang=\\"ts\\">import \\"../app.css\\";\\nimport Header from \\"./Header.svelte\\";\\nimport { Toaster } from \\"$lib/components/ui/sonner\\";\\n<\/script>\\n\\n<div class=\\"app bg-slate-50\\">\\n  <Header></Header>\\n\\n  <main class=\\"p-4 mt-12 sm:ml-64\\">\\n    <slot></slot>\\n  </main>\\n\\n  <footer class=\\"p-4 mt-12 sm:ml-64\\">\\n    <p>Copyright © 2024 Warchive. All rights reserved.</p>\\n  </footer>\\n\\n  <Toaster />\\n</div>\\n\\n<style>\\n  .app {\\n    display: flex;\\n    flex-direction: column;\\n    min-height: 100vh;\\n  }\\n\\n  footer {\\n    display: flex;\\n    flex-direction: column;\\n    justify-content: center;\\n    align-items: center;\\n    padding: 12px;\\n    font-size: small;\\n  }\\n\\n  @media (min-width: 480px) {\\n    footer {\\n      padding: 12px 0;\\n    }\\n  }\\n</style>\\n"],"names":[],"mappings":"AAoBE,kBAAK,CACH,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,UAAU,CAAE,KACd,CAEA,oBAAO,CACL,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,IAAI,CACb,SAAS,CAAE,KACb,CAEA,MAAO,YAAY,KAAK,CAAE,CACxB,oBAAO,CACL,OAAO,CAAE,IAAI,CAAC,CAChB,CACF"}'
};
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="app bg-slate-50 svelte-2gu5lj">${validate_component(Header, "Header").$$render($$result, {}, {}, {})} <main class="p-4 mt-12 sm:ml-64">${slots.default ? slots.default({}) : ``}</main> <footer class="p-4 mt-12 sm:ml-64 svelte-2gu5lj" data-svelte-h="svelte-2cvzer"><p>Copyright © 2024 Warchive. All rights reserved.</p></footer> ${validate_component(Sonner_1, "Toaster").$$render($$result, {}, {}, {})} </div>`;
});
export {
  Layout as default
};
